...
// 1. Update 08wq3b45gsv3v.js for small, elegant 3D Waypoint Pins
let c08 = fs.readFileSync('/home/jay/office-graffico-clone/_next/static/chunks/08wq3b45gsv3v.js', 'utf8');

// Ensure em has clean numbered stations matching the tour
const oldEmPattern = /let em=\[\{id:"radio",label:.*?CamTarget:\[5\.48,-3\.06,-2\.49\]\}\]\}/s;

// Replace eT implementation with compact pin + toggle support
const oldETPattern = /function eT\(\{hotspot:e,phaseRef:o,lockedRef:l,onEnter:i\}\)\{.*?\}\)\}\):null\)\}/s;
...
const newETCode = `function eT({hotspot:e,phaseRef:o,lockedRef:l,onEnter:i}){
  ...
  if(showPins){
    ...
    let shortName = e.short || (e.label.split(":")[0] || e.label).replace(/^[^a-zA-Z0-9\u00C0-\u024F\u1E00-\u1EFF]+/,"").trim();
    return (0,t.jsx)(ew.Html,{
      position:[e.anchor[0], e.anchor[1]+0.2, e.anchor[2]],
      center:!0,
      distanceFactor:14,
      zIndexRange:[5,5],
      children:(0,t.jsxs)("div",{
        style:{
          ...
          boxShadow:"0 3px 10px rgba(0,0,0,0.5), 0 0 8px rgba(225,29,72,0.3)",
          pointerEvents:"none",
          userSelect:"none",
...
// Update 08wq3b45gsv3v.js
if (c08.includes("function eT(")) {
  let sIdx = c08.indexOf("function eT(");
  let eIdx = c08.indexOf("function eS(", sIdx);
  c08 = c08.substring(0, sIdx) + newETCode + c08.substring(eIdx);
  fs.writeFileSync('/home/jay/office-graffico-clone/_next/static/chunks/08wq3b45gsv3v.js', c08, 'utf8');
  console.log("Updated 08wq3b45gsv3v.js with compact 3D Waypoint Pins and H-key toggle");
}

// 2. Update 2nb77gdn5hy4t.js for Compact Guide Tour HUD and Modal
...
const newTourReactComponent = `function UnionFamReactTour({inspecting:o,inspectId:c}){
  ...
  return (0,S.jsxs)(S.Fragment,{children:[
    ...
    (0,S.jsxs)("div",{
      ...
      children:[
        (0,S.jsxs)("div",{
          style:{background:"rgba(15,23,42,0.92)",backdropFilter:"blur(12px)",border:"1px solid rgba(225,29,72,0.4)",borderRadius:18,padding:"5px 12px",display:"flex",alignItems:"center",gap:8,pointerEvents:"auto",boxShadow:"0 6px 20px rgba(0,0,0,0.5)"},
          children:[
        ...
        (0,S.jsxs)("div",{
          style:{background:"rgba(15,23,42,0.92)",backdropFilter:"blur(12px)",border:"1px solid rgba(51,65,85,0.7)",borderRadius:18,padding:"4px 6px",display:"flex",alignItems:"center",gap:4,pointerEvents:"auto",boxShadow:"0 6px 20px rgba(0,0,0,0.5)"},
          children:[
    ...
    !showTour&&!o&&(0,S.jsx)("div",{
      ...
      children:(0,S.jsx)("button",{
        ...
        style:{background:"rgba(15,23,42,0.9)",backdropFilter:"blur(8px)",border:"1px solid rgba(225,29,72,0.5)",color:"#f8fafc",padding:"6px 12px",borderRadius:16,fontSize:11,fontWeight:"700",cursor:"pointer",boxShadow:"0 4px 12px rgba(0,0,0,0.5)",display:"flex",alignItems:"center",gap:6},
...
// Replace UnionFamReactTour in 2nb77gdn5hy4t.js
let tourStart = c2n.indexOf("function UnionFamReactTour(");
if (tourStart !== -1) {
  let tourEnd = c2n.indexOf("var rx=", tourStart);
  if (tourEnd === -1) {
    // If rx not after, find end of function
    let lastBrace = c2n.lastIndexOf("}])");
    // Let's replace up to before the closing module exports
    c2n = c2n.substring(0, tourStart) + newTourReactComponent + c2n.substring(c2n.indexOf("var rx=", tourStart));
  } else {
  ...
  console.log("Updated 2nb77gdn5hy4t.js with sleek compact UnionFamReactTour");
}
